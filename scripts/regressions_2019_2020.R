...
create_regression_table_file(
  ...
  table_title = "2019 to 2020, Employed to Unemployed",
  output_file_name = "employed_to_unemployed_2019_to_2020"
)
create_regression_table_file(
  model_list = list(
  ...
  table_title = "2019 to 2020, Employed to Not-Employed",
  output_file_name = "employed_to_not_employed_2019_to_2020"
)
