...
# PARAMETERS
year_pair <- c("20_21")
inner_join_fy = inner_join_20
empl_in_fy = empl_in_2020
...
create_regression_table_file(
  ...
  table_title = "2020 to 2021, Employed to Unemployed",
  output_file_name = "employed_to_unemployed_2020_to_2021"
)
create_regression_table_file(
  model_list = list(
  ...
  table_title = "2020 to 2021, Employed to Not-Employed",
  output_file_name = "employed_to_not_employed_2020_to_2021"
)
if (year_pair %in% c("19_20_cov", "19_21", "20_21", "21_22")) {  # TODO: Check if correct and if yes, generalize to other files.
  create_regression_table_file(
    model_list = list(
    ...
    table_title = "2020 to 2021, Employed to Short-Time Work",
    output_file_name = "employed_to_short_time_work_2020_to_2021"
  )
}
