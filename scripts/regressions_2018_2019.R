...
# PARAMETERS
year_pair <- c("18_19")
inner_join_fy = inner_join_18
empl_in_fy = empl_in_2018
inner_join_sy = inner_join_19
...
create_regression_table_file(
  ...
  table_title = "2018 to 2019, Employed to Unemployed",
  output_file_name = "employed_to_unemployed_2018_to_2019"
)
create_regression_table_file(
  model_list = list(
  ...
  table_title = "2018 to 2019, Employed to Not-Employed",
  output_file_name = "employed_to_not_employed_2018_to_2019"
)
